...
var $Search = function(element, options) {
    ...
    var _init = function() {
        ...
        // Set initialized
        the.element.setAttribute('data-pdms-search', 'true');
    ...
    var _handlers = function() {
        ...
        if ( the.menuObject ) {
            ...
            if ( the.toggleElement ) {
                ...
                the.menuObject.on('pdms.menu.dropdown.show', function(item) {
                ...
                the.menuObject.on('pdms.menu.dropdown.hide', function(item) {
                    if ($Util.visible(the.toggleElement)) {
            ...
            the.menuObject.on('pdms.menu.dropdown.shown', function() {
    ...
    var _search = function() {
        if (the.processing === false) {
            ...
            the.processing = true;
            $EventHandler.trigger(the.element, 'pdms.search.process', the);
        }
    }
    ...
    // Clear
    var _clear = function() {
        if ( $EventHandler.trigger(the.element, 'pdms.search.clear', the) === false )  {
            return;
        }
        ...
        $EventHandler.trigger(the.element, 'pdms.search.cleared', the);
    }
