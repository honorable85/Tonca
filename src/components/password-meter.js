...
var $PasswordMeter = function(element, options) {
    ...
    var _init = function() {
        ...
        the.highlightElement = the.element.querySelector('[data-pdms-password-meter-control="highlight"]'); 

        // Set initialized
        the.element.setAttribute('data-pdms-password-meter', 'true');
...
// Create instances
$PasswordMeter.createInstances = function(selector = '[data-pdms-password-meter]') {
    // Get instances
...
if (document.readyState === 'loading') {
   document.addEventListener('DOMContentLoaded', $PasswordMeter.init);
} else {
    $PasswordMeter.init();
}
